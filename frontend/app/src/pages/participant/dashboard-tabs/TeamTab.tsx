    ...
    <div className="mt-6 space-y-6">
      ...
      {approvalStatus === 'PENDING' && (
        <div className="flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
          ...
          <div>
            <p className="text-sm font-semibold text-amber-800">Заявка на розгляді</p>
            <p className="text-xs text-amber-700 mt-0.5">
              Ваша заявка або зміни очікують затвердження організатором. Ми повідомимо вас після розгляду.
            </p>
          </div>
        </div>
      )}
      ...
      {approvalStatus === 'REJECTED' && (
        <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4">
          ...
          <div>
            <p className="text-sm font-semibold text-red-800">Заявку відхилено</p>
            {approvalComment
              ? <p className="text-xs text-red-700 mt-0.5">Причина: <span className="font-medium">{approvalComment}</span></p>
              : <p className="text-xs text-red-700 mt-0.5">Організатор не вказав причини. Зв’яжіться з організаторами хакатону.</p>
            }
          </div>
        </div>
      )}
      ...
      {approvalStatus === 'DISQUALIFIED' && (
        <div className="flex items-start gap-3 rounded-xl border border-orange-200 bg-orange-50 px-5 py-4">
          ...
          <div>
            <p className="text-sm font-semibold text-orange-800">Команду дискваліфіковано</p>
            {approvalComment
              ? <p className="text-xs text-orange-700 mt-0.5">Причина: <span className="font-medium">{approvalComment}</span></p>
              : <p className="text-xs text-orange-700 mt-0.5">Зв’яжіться з організаторами для уточнення.</p>
            }
          </div>
        </div>
      )}
