...
import { Trophy, Star, AlertTriangle, Calendar, Clock, CheckCircle2, XCircle, Hourglass, Trash2, Plus, RefreshCw } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Конфліктів суддів',   val: conflicts.length,   icon: AlertTriangle, cls: 'text-red-500' },
          { label: 'Треків',              val: tracks.length,       icon: Star, cls: 'text-blue-500' },
