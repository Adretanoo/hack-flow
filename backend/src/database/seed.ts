...
import {
  ...
  mentorAvailabilities, mentorSlots,
...
async function seedMentorAvailabilities(hackathons: any, users: any, teams: any) {
  ...
  await db.insert(mentorSlots).values([
    { mentorAvailabilityId: avail2.id, teamId: teams['NeuralNinjas'].id, startDatetime: m2Start, durationMinute: 30, status: 'booked' }
  ]);
